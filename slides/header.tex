...
\definecolor{violet2}{RGB}{221,160,221}
\definecolor{violet1}{RGB}{186,85,211}
\newenvironment{curiositybox}[1][upper=violet1,lower=violet2,shadow=false]{\begin{tcolorbox}[title=Note, size=small,coltitle=black,colback=white,colframe=violet1,colbacktitle=violet2]}{\end{tcolorbox}}
...
\definecolor{verdeacqua}{RGB}{100, 120, 210}
...
\lstdefinestyle{bashstyle}{
    ...
    moredelim=**[is][\bfseries\color{teal}]{@}{@}  % Define delimiter for highlighted lines   
}
...
\definecolor{CustomViolet}{RGB}{106, 0, 183}
...
\lstdefinestyle{cmakestyle}{
  ...
  keywordstyle=\color{verdeacqua}\bfseries,
  commentstyle=\color{commentgreen},
  ...
  keywordstyle=\color{teal}\bfseries,           % Style for additional keywords
